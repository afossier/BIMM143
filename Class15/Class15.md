...
```
    ...
    ## Old packages: 'blogdown', 'caTools', 'knitr', 'Matrix', 'processx',
    ##   'RcppArmadillo', 'rgl', 'sys', 'XML'
...
```
    ...
    ##  /var/folders/xk/3ywjjmz174nbp800f8v8ln1m0000gn/T//RtmpuBsxOR/downloaded_packages
